...
PATH_LIST = [
    ...
    HERE / "problem_dqn" / "summary.csv",
    HERE / "problem_ddqn" / "summary.csv",
]
...
def plot_combined_results(data_list, output_path: Path):
    fig, axes = plt.subplots(1, 3, figsize=(18, 5.5))
    ax1, ax2, ax3 = axes

    problem_names  = ["P3\nPPO", "P4\nPPO-Mask", "P5\nPPO-Lagrange", "P6\nPPO-Opt", "DQN", "DDQN"]
    method_legend_names = ["P3 PPO", "P4 PPO-Mask", "P5 PPO-Lagrange", "P6 PPO-Opt", "DQN", "DDQN"]
    pal_ilp    = "#e74c3c"
    pal_random = "#95a5a6"
    pal_method = ["#3498db", "#2ecc71", "#e67e22", "#9b59b6", "#1abc9c", "#f39c12"]
    ...
    for xi in range(len(problem_names)):
        ...
        ax2.bar(xi + bw/2, method_viol[xi], bw, color=pal_method_2[xi], alpha=0.8,
                label=method_legend_names[xi], zorder=3)
...
def main():
    ...
    plot_combined_results(combined_data, output_path=HERE / "combined_results.png")
