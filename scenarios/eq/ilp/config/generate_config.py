"""
Regenerate config_ecu_eq_svc.yaml with ALL scenarios guaranteed ILP-feasible.
Same generator as scenarios/lt/ilp/config/generate_config.py, just N_ECUS/N_SVCS
sized for the "eq" scenario (ECU count == SVC count).
"""
...
if __name__ == "__main__":
    ...
    write_config(scenarios, "config_ecu_eq_svc.yaml")
