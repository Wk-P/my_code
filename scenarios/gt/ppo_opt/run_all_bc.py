...
def train_ppo_bc(ecus, services, device: str):
    ...
    # eq/lt's P6Env) — sorted_desc=False keeps expert actions
    # aligned with the env's actual (unsorted) presentation order.
    obs_arr, _mask_arr, act_arr = build_bc_dataset(C.TRAIN_SCENARIOS, P6Env, use_mask=False, sorted_desc=False)
